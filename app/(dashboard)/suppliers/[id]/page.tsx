  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold tracking-tight">Edit Supplier</h1>
          <p className="mt-0.5 text-sm text-muted-foreground">Update supplier information</p>
        </div>
      </div>
